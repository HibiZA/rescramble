...
export const SHIPS = SHIP_CONFIGS.map(cfg => ({
  ...
  fuelBurnMult: cfg.fuelBurnMult || 1.0,
  damageBonus: cfg.damageBonus || 0,
  killSpeedFrames: cfg.killSpeedFrames || 0,
  fuelPauseOnKill: cfg.fuelPauseOnKill || 0,
...
export function createPlayer(id, x, y, shipType) {
  ...
  return {
    ...
    fuelBurnMult: ship.fuelBurnMult,
    damageBonus: ship.damageBonus,
    killSpeedFrames: ship.killSpeedFrames,
    fuelPauseOnKill: ship.fuelPauseOnKill,
    fuelPauseTimer: 0,
    bombs: 1,
    fuel: FUEL.startFuel,
